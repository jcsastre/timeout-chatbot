...
public class BarSummaryBlock {
    ...
    public void send(String userId, String barId) {

        final Bar bar =
            restTemplate.getForObject(
                GraffittiEndpoints.VENUE.toString() + barId,
                Bar.class
            );

        sendSummary(userId, bar);

        sendImages(userId, barId, bar);
