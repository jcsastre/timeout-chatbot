...
public class ItemStatePayloadHandler {
    ...
    private final BackFromItemAction backHandler;
    ...
    public ItemStatePayloadHandler(
        ...
        BackFromItemAction backHandler,
        BlockPhotos blockPhotos, IntentPhotosHandler photosHandler, BlockError blockError,
